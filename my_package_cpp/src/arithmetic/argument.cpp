...
: Node("argument", node_options), min_random_num_(0.0), max_random_num_(0.0)
{
    ...
    timer_ = this->create_wall_timer(1s, std::bind(&Argument::publish_random_arithmetic_arguments, this));
}
...
void Argument::publish_random_arithmetic_arguments()
{
    ...
    my_interface::msg::ArithmeticArgument msg;
    msg.stamp = this->now();
